...
# Adam + LinearWarmup
ADAM_LR = 3e-4              # Initial learning rate (just after warmup)
                                # in ddp model, real LR:= LR/GPUS
ADAM_WARMUP_STEPS = 50      # Number of warmup steps
ADAM_WEIGHT_DECAY = 0.005   # weight:= weight*(1-decay_rate)
