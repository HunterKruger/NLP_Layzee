...
LOG_INTERVAL = 10          # step intervals for displaying train loss and metrics 
...
TENSORBOARD_TIME = 1000                                                                  # tensorboard flush seconds, choose a value which is longer than the training process
