...
def main():
    ...
    with mirrored_strategy.scope():
        model_new = create_model(summary=False, do_train=False)
    ...
    if mode == 1:
        ...
        y_pred_tk, y_truth_tk = prepare_for_token_eval(y_pred, tags_test, 'O') 
        ...
        t5 = time.time()
        res_pred, res_truth = prepare_for_tag_eval(y_pred, tags_test, 'O')
