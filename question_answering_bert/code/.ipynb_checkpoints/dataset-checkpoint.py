...
class CustomDataset(tf.keras.utils.Sequence):
    ...
    def __init__(self, 
                 questions, documents, starts, ends,
...
#         documents = self.data[config.DOCUMENT_FIELD].loc[indexes].values.astype("str").tolist()
#         questions = self.data[config.QUESTION_FIELD].loc[indexes].values.astype("str").tolist()
