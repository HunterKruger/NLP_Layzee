...
### GPU
CUDA_VISIBLE_DEVICES = '15,14,13,12'   # specifiy GPU ids (use nvidia-smi)
...
MAX_LEN_SIAMESE = 32
EPOCHS = 4
BATCH_SIZE = 32           # for train, val and test
...
TRAIN_FILE = '../data/customer_compare_train_data.xlsx'             
VALIDATION_FILE = '../data/customer_compare_dev_data.xlsx'
TEST_FILE = '../data/customer_compare_dev_data.xlsx'
ONLINE_TEST_FILE = '../data/online_test.txt'
SENTENCE_FIELD = 'text_A'
SENTENCE_FIELD2 = 'text_B'
LABEL_FIELD = 'text_label'
