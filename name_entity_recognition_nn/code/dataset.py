...
def process_text(data, 
    ...
    if fit_transform:
        ...
        tokenizer.fit_on_texts(token_docs)                               # fit data on the tokenizer
        ## save the tokenizer
    ...
    token_docs = tokenizer.texts_to_sequences(token_docs)                # transform data on the tokenizer
    ...
    if with_labels == False:      
        return token_docs, tokenizer  # X, tokenizer
    else:
        ...
        return token_docs, tag_docs_in_digit, tokenizer  # X, y, tokenizer
